...
🔹 Related concept: maxUnavailable
| Term               | Meaning               |
| ------------------ | --------------------- |
| **maxSurge**       | Extra pods allowed    |
| **maxUnavailable** | Pods that can go down |
...
1 new pod created
1 old pod removed
Update continues smoothly


🔹 Without Surge
If maxSurge: 0:
Kubernetes must delete old pod first ❌
Then create new pod ❌
👉 This can cause downtime


🔥 DevOps Interview Tip
👉 “Surge ensures zero downtime by temporarily increasing pod count during rolling updates.”
